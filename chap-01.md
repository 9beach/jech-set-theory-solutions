...
<span id="1.1">1.1.</span> Verify (1.1)$\qquad(a, b) = (c, d)$ if and only if $a = c$ and
$b = d$.
...
<span id="1.2">1.2.</span> There is no set $X$ such that $P(X) \subset X$.
...
<span id="1.3">1.3.</span> If $X$ is inductive, then the set $\{x \in X : x \subset X\}$ is
...
<span id="1.4">1.4.</span> If $X$ is inductive, then the set $\{x \in X : x \text{ is
...
<span id="1.5">1.5.</span> If $X$ is inductive, then the set $\{x \in X : x$ is transitive
...
<span id="1.6">1.6.</span> If $X$ is inductive, then $\{x \in X:x$ is transitive and every
...
<span id="1.7">1.7.</span> Every nonempty $X \subset \mathbb{N}$ has an $\in$-minimal
element.\
...
<span id="1.8">1.8.</span> If $X$ is inductive then so is $\{x\in X:x=\emptyset$ or $x=y\cup
...
<span id="1.10">1.10.</span> Each $n \in \mathbb{N}$ is T-finite.
...
<span id="1.11">1.11.</span> $\mathbb{N}$ is T-infinite; the set $\mathbb{N} \subset P$
...
<span id="1.12">1.12.</span> Every finite set is T-finite.
...
<span id="1.13">1.13.</span> Every infinite set is T-infinite.\
...
<span id="1.14">1.14.</span> The Separation Axioms follow from the Replacement Schema.\
...
<span id="1.15">1.15.</span> Instead of Union, Power Set, and Replacement Axioms consider the
